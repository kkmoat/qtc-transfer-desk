...
export class WithdrawalJob {
    ...
    free(): void;
    [Symbol.dispose](): void;
    aggregate(): WithdrawalResult;
    proveNextLeaf(): void;
    summary(): string;
}

export class WithdrawalResult {
    private constructor();
    free(): void;
    [Symbol.dispose](): void;
    summary(): string;
...
export class WormholeSession {
     ...
     */
    normalInfo(index: number): string;
    prepareWithdrawal(json: string): WithdrawalJob;
    readonly cleared: boolean;
}
...
export interface InitOutput {
    ...
    readonly __wbg_withdrawaljob_free: (a: number, b: number) => void;
    readonly __wbg_withdrawalresult_free: (a: number, b: number) => void;
    ...
    readonly withdrawaljob_aggregate: (a: number) => [number, number, number];
    readonly withdrawaljob_proveNextLeaf: (a: number) => [number, number];
    readonly withdrawaljob_summary: (a: number) => [number, number, number, number];
    readonly withdrawalresult_proofBytes: (a: number) => [number, number];
    readonly withdrawalresult_summary: (a: number) => [number, number];
    ...
    readonly wormholesession_normalInfo: (a: number, b: number) => [number, number, number, number];
    readonly wormholesession_prepareWithdrawal: (a: number, b: number, c: number) => [number, number, number];
