/* @ts-self-types="./quantus_wormhole_crypto.d.ts" */
...
export class WithdrawalJob {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WithdrawalJob.prototype);
        obj.__wbg_ptr = ptr;
        WithdrawalJobFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WithdrawalJobFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_withdrawaljob_free(ptr, 0);
    }
    /**
     * @returns {WithdrawalResult}
     */
    aggregate() {
        const ret = wasm.withdrawaljob_aggregate(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WithdrawalResult.__wrap(ret[0]);
    }
    proveNextLeaf() {
        const ret = wasm.withdrawaljob_proveNextLeaf(this.__wbg_ptr);
        if (ret[1]) {
    ...
    summary() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.withdrawaljob_summary(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) WithdrawalJob.prototype[Symbol.dispose] = WithdrawalJob.prototype.free;

export class WithdrawalResult {
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(WithdrawalResult.prototype);
        obj.__wbg_ptr = ptr;
        WithdrawalResultFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        WithdrawalResultFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_withdrawalresult_free(ptr, 0);
    }
    /**
     * @returns {Uint8Array}
     */
    get proofBytes() {
        const ret = wasm.withdrawalresult_proofBytes(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
    ...
    summary() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.withdrawalresult_summary(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
...
if (Symbol.dispose) WithdrawalResult.prototype[Symbol.dispose] = WithdrawalResult.prototype.free;
...
export class WormholeSession {
    ...
    normalInfo(index) {
        ...
        let deferred2_1;
        try {
            const ret = wasm.wormholesession_normalInfo(this.__wbg_ptr, index);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
    ...
    /**
     * @param {string} json
     * @returns {WithdrawalJob}
     */
    prepareWithdrawal(json) {
        const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wormholesession_prepareWithdrawal(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return WithdrawalJob.__wrap(ret[0]);
    }
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./quantus_wormhole_crypto_bg.js": import0,
    };
}
...
const WithdrawalJobFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_withdrawaljob_free(ptr >>> 0, 1));
const WithdrawalResultFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_withdrawalresult_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('quantus_wormhole_crypto_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
